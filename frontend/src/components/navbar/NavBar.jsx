        ...
        <Navbar expand="lg">
          ...
          <Navbar.Collapse id="navbar-nav">
            ...
            <div className="col-lg-4 col-md-12 mx-auto">
              <Nav>
                {!auth.user ? (
                  <button type="button" className="btn btn-success me-2 my-2" onClick={handleLogin}>
                    Log in
                  </button>
                ) : (
                  <button type="button" className="btn btn-outline-success me-2 my-2" onClick={handleLogout}>
                    Log out
                  </button>
                )}

                {!auth.user ? (
                  <button type="button" className="btn btn-outline-success me-2 my-2" onClick={handleSignup}>
                    Sign up
                  </button>
                ) : (
                  <p></p>
